...
def main_worker(gpu, ngpus_per_node, args):
    ...
    if args.pretrained and not args.resume:
        ...
        print(type(model.features.init_block.conv.conv))
        print(dir(model.features.init_block.conv.conv))
        print(model.features.init_block.conv.conv.weight[0][0])
        print(model.features.init_block.conv.conv.bias)
...
def validate(val_loader, model, criterion, args):
    ...
    progress = ProgressMeter(
        ...
        prefix='Test: ')
    print(model.quant_init_block_convbn.conv.weight[0][0])
    print(model.quant_init_block_convbn.weight_bit)
